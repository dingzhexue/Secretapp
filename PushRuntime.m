...
@property (NS_NONATOMIC_IOSONLY, getter=getPushwooshDelegate, readonly, strong) NSObject<PushNotificationDelegate> *pushwooshDelegate;
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL pushwooshDontAutoRegister;
@end
