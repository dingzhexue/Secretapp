...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        [self.blank setBackgroundImage:[UIImage imageNamed:@"backtextbax.png"] forState:UIControlStateNormal];
        [self.blank setBackgroundImage:[UIImage imageNamed:@"backtextbax.png"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews
{
    ...
    self.one.frame = CGRectMake(100.0f, buttonTop, leftButtonWidth, buttonHeight);
