...
- (void)loadURL:(NSString*)url get:(NSDictionary*)getParams {
    ...
    if([[request.URL absoluteString] rangeOfString:@"feed"].location != NSNotFound)
    {
        ...
        /*UIWebView *webView;
        if(UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPad)
            webView = [[[UIWebView alloc] initWithFrame:CGRectMake(35, 680, 400, 100)] autorelease];
        else
            webView = [[[UIWebView alloc] initWithFrame:CGRectMake(25, 310, 250, 60)] autorelease];
        NSString *likePage = @"http://www.facebook.com/pages/My-Short-Sale-Score/242779072468511";
       ...
       // webView.scrollView.bounces = NO; //supported in ios 5
