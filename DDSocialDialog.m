...
@property (NS_NONATOMIC_IOSONLY, readonly) CGAffineTransform transformForOrientation;
...
- (instancetype)initWithFrame:(CGRect)frame theme:(DDSocialDialogTheme)theme 
{
    if ((self = [super initWithFrame:CGRectZero])) 
    {
        ...
        self.backgroundColor=  [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"iphone-r-bg.png"]];
        //self.backgroundColor = [UIColor clearColor];
        self.autoresizesSubviews = YES;
        self.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
        self.contentMode = UIViewContentModeRedraw;
        
        //UIColor* color = [UIColor colorWithRed:166.0/255 green:125.0/255 blue:61.0/255 alpha:1];
        ...
        titleLabel_ = [[UIImageView alloc] init];
        titleLabel_.image=[UIImage imageNamed:@"sure-to-delete.png"];
...
//    UIColor *DDSocialDialogBorderColor;
    ...
    {
        //DDSocialDialogTitleBackgroundColor = [UIColor whiteColor];
        //DDSocialDialogTitleStrokeColor = [UIColor colorWithRed:0.500 green:0.500 blue:0.500 alpha:1.0];
        //DDSocialDialogBlackStrokeColor = [UIColor colorWithRed:0.500 green:0.500 blue:0.500 alpha:1.0];
        //DDSocialDialogBorderColor = [UIColor colorWithRed:0.500 green:0.500 blue:0.500 alpha:0.3];
    }
    else 
    {
        //DDSocialDialogTitleBackgroundColor = [UIColor whiteColor];
        //DDSocialDialogTitleStrokeColor = [UIColor colorWithRed:127.0/255 green:108.0/255 blue:36.0/255 alpha:1.0];
        //DDSocialDialogBlackStrokeColor = [UIColor colorWithRed:127.0/255 green:108.0/255 blue:36.0/255 alpha:1.0];
...
- (void)show 
{
    ...
    UIImage *img=[UIImage imageNamed:@"sure-to-delete.png"];
    titleLabel_.frame = CGRectMake((kDDSocialDialogBorderWidth + kDDSocialDialogTitleMarginX)*3,
                                   kDDSocialDialogBorderWidth*2,
...
- (void)keyboardDidShow:(NSNotification*)notification 
{
    ...
    CGSize screenSize = [UIScreen mainScreen].bounds.size;
    CGSize keyboardSize = [self convertRect:[(notification.userInfo)[UIKeyboardFrameEndUserInfoKey] CGRectValue] toView:nil].size;
